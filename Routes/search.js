...
router.get('/:id',(request,response)=>{
    ...
    console.log(myUrl.searchParams.get('location'));
    console.log(myUrl.searchParams.get('product'));
    console.log(myUrl.searchParams.get('service'));
    console.log(myUrl.searchParams.getAll('location'))
    companyModel.find({ location: myUrl.searchParams.getAll('location')}).then((docs)=>{
        console.log(docs);
    })
